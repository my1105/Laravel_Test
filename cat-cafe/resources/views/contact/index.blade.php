    ...
    <div class="mt-8">
      ...
      @csrf
        <div class="mb-4">
          ...
          <input id="name" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border" type="text" name="name" value="{{old('name')}}" placeholder="例）田中太郎">
          @if($errors->has('name'))
        ...
        <div class="mb-4">
          ...
          <input id="name_kana" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border" type="text" name="name_kana" value="{{old('name_kana')}}" placeholder="例）タナカタロウ">
          @error('name_kana')
        ...
        <div class="mb-4">
          ...
          <input id="phone" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border" type="text" name="phone" value="{{old('phone')}}" placeholder="例）0312345678">
          @error('phone')
          <p class="text-red-400">{{ $message }}</p>
          @enderror
        </div>
        <div class="mb-4">
          ...
          <input id="email" class="w-full p-4 text-xs leading-none bg-blueGray-50 rounded outline-none border" type="email" name="email" value="{{old('email')}}" placeholder="info@example.com">
          @error('email')
          <p class="text-red-400">{{ $message }}</p>
          @enderror
        </div>
        <div class="mb-4">
          ...
          <textarea id="body" class="w-full h-24 p-4 text-xs leading-none resize-none bg-blueGray-50 rounded outline-none border" type="text" name="body" placeholder="ご自由にご記入ください">{{old('body')}}</textarea>
          @error('body')
          <p class="text-red-400">{{ $message }}</p>
          @enderror
        </div>
